                ...
                <div class="collapse navbar-collapse text-ligth " id="navbarNav">
                    <ul class="nav navbar-nav ms-auto  d-flex align-items-center">
                        <li class="bar nav-item active ">
                            <a class="nav-link me-5 text-light " href="admin.php">Payment</a>
                        </li>
                        <li>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="content" class="form-label">DETAIL PRODUK</label>
                    <input type="text" name="content" class="form-control" id="content">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-dark" data-bs-dismiss="modal">Cancel</button>
                <button type="submit" name="detailproduk" class="btn btn-dark">Post</button>
            </div>
        </form>
    </div>
</div>
...
<section class="container">
  ...
  <!-- Modal -->
  <div class="modal fade" id="modal<?= $produk['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <form action="" method="post" enctype="multipart/form-data">
            <?php 
                $id =  $produk['id']; 
                $edit = query("SELECT * FROM detailproduk WHERE id = $id");
                ?>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-dark" data-bs-dismiss="modal">Cancel</button>
          <button type="submit" name="edit" class="btn btn-dark">Send</button>
        </div>
        <?php endforeach ?>
      </form>
    </div>
  ...
  <td>
    <form action="" method="post">
      ...
      <button class="btn btn-dark text-light" type="submit" name="hapus">Delete</button>
    </form>
  </td>
</tr>
<?php  
